...
export default function AddOrUpdatePets() {
     ...
     const handleSearch = () => {
          if (!searchTerm) {
               ...
               const filtered = petsList.filter(p => p.name.toLowerCase().includes(searchTerm.toLowerCase()));
               ...
               {mode === 'update' && (
                    ...
                    <div className={styles.updateHeader}>
                         <div className={styles.searchRow}>
                              ...
                              <button className={styles.backButton} onClick={() => { setMode(null); setSelectedPet(null); setSearchTerm(''); loadPets(); }}>
                                   Back
                              </button>
                         </div>
                    </div>
